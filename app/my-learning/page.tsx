...
export const metadata: Metadata = {
  ...
  description: "Pick up your courses where you left off.",
};
  ...
  return (
    <main className="home-shell courses-page-shell">
      <header className="home-header">
        ...
        <nav className="home-nav" aria-label="Main navigation"><Link href="/courses">Courses</Link><Link className="active" href="/my-learning">My Learning</Link></nav>
        <div className="home-actions"><span className="icon-button" aria-hidden="true"><Icon name="bell" /></span><HeaderAuth /></div>
      </header>
      <section className="all-courses-content" aria-labelledby="my-learning-title">
        <div className="all-courses-heading"><div><p className="eyebrow">Keep going</p><h1 id="my-learning-title">My Learning</h1><p>Pick up your courses where you left off.</p></div><Link href="/courses" className="all-courses-back">Browse all courses <Icon name="arrow" /></Link></div>
        {courses.length ? (
          ...
          <div className="my-learning-empty">
            ...
            <p>Explore the catalog and start a course to see it here.</p>
            <Link href="/courses" className="course-primary-action">Explore courses <Icon name="arrow" /></Link>
          </div>
        )}
      </section>
    </main>
