    ...
    <main className="lesson-shell">
      ...
      <div className="lesson-layout">
        ...
        <article className="lesson-main">
          ...
          <div className="lesson-heading"><div><span className="lesson-eyebrow">Lesson {moduleIndex + 1}.{lessonIndex + 1}</span><h1>{lesson.title}</h1><p>Learn how Next.js handles data fetching and caching in both Server and Client Components.</p></div><button className="lesson-bookmark" type="button" aria-label="Bookmark lesson"><Icon name="bookmark" /></button></div>
          ...
          <LessonTabs notes={<div className="lesson-notes">{lesson.notes?.length ? <PortableText value={lesson.notes as never[]} /> : <p>No notes have been added for this lesson yet.</p>}</div>}>
            <section className="lesson-content-section"><h2>Overview</h2><p>In this lesson, you’ll learn how Next.js handles data fetching and caching in both Server and Client Components. We’ll explore different caching strategies and revalidation techniques to build fast and scalable applications.</p></section>
